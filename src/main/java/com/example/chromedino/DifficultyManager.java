...
public class DifficultyManager {
    ...
    public void drawDifficulties(GraphicsContext gc) {
        ...
        for (int i = 0; i < difficulties.length; i++) {
            ...
            //draw all buttons
            gc.drawImage(difficulties[i], x, difficultyYPositions[i], difficulties[i].getWidth() / 2, difficultyHeights[i]);
        }
    }
    ...
    public void handleMouseClick(MouseEvent event) {
        ...
        for (int i = 0; i < difficulties.length; i++) {
            ...
            if (clickX >= difficultyX && clickX <= (difficultyX + difficulties[i].getWidth() / 2) && clickY >= difficultyY && clickY <= (difficultyY + difficultyHeights[i]) && !difficultySelected) {
    ...
    public void handleMouseMoved(MouseEvent event) {
        ...
        for (int i = 0; i < difficulties.length; i++) {
            ...
            if (mouseX >= difficultyX && mouseX <= (difficultyX + difficulties[i].getWidth() / 2) && mouseY >= difficultyY && mouseY <= (difficultyY + difficultyHeights[i])) {
