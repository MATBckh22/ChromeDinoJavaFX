...
public class SceneryManager {
    ...
    public void handleMouseClick(MouseEvent event) {
        ...
        for (int i = 0; i < sceneries.length; i++) {
            ...
            if (clickX >= sceneryX && clickX <= (sceneryX + sceneryWidths[i]) && clickY >= sceneryY && clickY <= (sceneryY + sceneries[i].getHeight() / 2) && !scenerySelected) {
    ...
    public void handleMouseMoved(MouseEvent event) {
        ...
        for (int i = 0; i < sceneries.length; i++) {
            ...
            if (mouseX >= sceneryX && mouseX <= (sceneryX + sceneryWidths[i]) && mouseY >= sceneryY && mouseY <= (sceneryY + sceneries[i].getHeight() / 2)) {
