...
import misc.DifficultyManager;
import com.example.chromedino.Mountains;
import misc.SceneryManager;
...
public class GameScene extends Canvas {
    ...
    public GameScene(Scene scene, GraphicsContext gc){
        ...
        String[] imagePaths = {"background layer 0.png", "background layer 1.png", "background layer 2.png", "background layer 3.png"};
        double[] startYs = {0, 10, 25, 25};
        //balloons
        String[] balloonImagePaths = {"hot air balloon blue lime.png", "hot air balloon green lime.png", "hot air balloon red yellow.png"};
    ...
    private void update(){
        ...
        switch(gameState){
            ...
            case GAME_IN_PROGRESS:
                ...
                if(!dManager.getSelectedDifficulty().equals("Zen")) score.scoreUp();
                break;
            default:
                break;
        }
    ...
    private void startScreen(GraphicsContext gc) {
        ...
        if(dManager.getSelectedDifficulty().equals("Zen")){
            ...
            gc.drawImage(endlessImage, centerX, centerY - 25, endlessImage.getWidth()/2, endlessImage.getHeight()/2);
        }
        else{
            //load intro image
